...
// Función para agregar el botón "Copy to Clipboard" automáticamente
function addCopyButtonsToCodeBlocks() {
  ...
  codeBlocks.forEach((codeBlock) => {
    ...
    copyButton.addEventListener('click', () => {
      ...
      setTimeout(() => {
        copyButton.innerHTML = '<i class="fas fa-clipboard"></i>'; // Restaura el icono "Copy to Clipboard" después de 2 segundos
      }, 2000);
    });
